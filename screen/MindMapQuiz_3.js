...
export default function MindMapQuiz() {
  ...
  const handleYes = () => {
    setModalVisible(false);
    navigation.navigate("NavKuis3");
  };
  return (
    <SafeAreaView style={styles.container}>
      <ImageBackground source={require('../assets/quiz/mindmap_3.png')} style={styles.imageContainer}>
        <Pressable style={styles.textContainer} onPress={handlePress}>
          <Text style={styles.text}>Mulai Kuis 3</Text>
        </Pressable>
      </ImageBackground>
      <CustomModal
