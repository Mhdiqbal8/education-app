...
export default function MindMapQuiz() {
  ...
  const handleYes = () => {
    setModalVisible(false);
    navigation.navigate("NavKuis1");
  };
  return (
    <SafeAreaView style={styles.container}>
      <ImageBackground source={require('../assets/quiz/mindmap_1.png')} style={styles.imageContainer}>
        <Pressable style={styles.textContainer} onPress={handlePress}>
          <Text style={styles.text}>Mulai Kuis 1</Text>
        </Pressable>
      </ImageBackground>
      <CustomModal
