...
export default function Soal_4() {
  ...
  const correctAnswer = 'Zn dalam nanopartikel Zn0 berfungsi sebagai antioksidan dan penting untuk struktur fungsi berbagai protein'
  const correctPosition = 'button_5'
  const corretUrl = 'kuis_4_soal_5'
  const wrongUrl = 'pembahasan_4_4'
  const imgSource = '../../../assets/quiz/kuis_4/soal_4.png'
